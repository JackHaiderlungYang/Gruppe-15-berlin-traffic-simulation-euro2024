...
#SBATCH --mail-user=zhiao.yang@campus.tu-berlin.de   # Your email address


module load java/21


java -Xmx120G -Xms120G -cp matsim-berlin-6.4-v6.0-350-g04d23cd-dirty.jar \
    org.matsim.run.OpenBerlinScenario run \
    --10pct \
    --config input/v6.4/berlin-v6.4-closelink.config.xml
